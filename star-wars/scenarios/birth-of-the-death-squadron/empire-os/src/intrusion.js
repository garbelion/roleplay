...
// Encadre un message de changement de phase dans une boîte box-drawing (3 lignes), pour
// l'afficher comme des lignes de console plutôt qu'un bandeau. Ex. asciiBanner('Kessel-Tho') ->
//   ┌────────────┐
//   │ Kessel-Tho │
//   └────────────┘
