...
> **À compléter (TODO MJ).** Réservez ici les fiches des personnages pré-tirés
> (cellule / équipage ayant capté le signal de Tana). Emplacement prévu pour 4 à 6
> fiches : identité, motivations, atouts utiles à une enquête d'infiltration
> (contacts, technique, discrétion, baratin, force). *Section volontairement laissée
> vierge dans cette version.*
