...
encart(b, null, [
  EP("*Profils au format **« visions de légendes »** (variante D6 francophone — cf. feuilles **FDPJ / FDADV** du dossier). Six attributs : **Coordination, Savoir, Perception, Mécanique, Technique, Vigueur**. Les compétences non citées valent la valeur de leur attribut. Reportez **Initiative, Ténacité / Vitalité** et la **Pénalité de coordination** sur la fiche selon les règles ; ajustez les dés à votre création de personnage.*"),
]);
